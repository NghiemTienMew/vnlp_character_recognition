"""
config.py - Cấu hình cho mô hình và quá trình huấn luyện (đã sửa lỗi)
"""
import os
import yaml
...
class Config:
    ...
    def _post_process_config(self) -> None:
        ...
        self.config['data']['char_to_idx'] = {char: idx + 3 for idx, char in enumerate(chars)}  # +3 cho special tokens
        self.config['data']['idx_to_char'] = {idx + 3: char for idx, char in enumerate(chars)}
        ...
        self.config['data']['num_classes'] = len(chars) + 3  # +3 cho <pad>, <sos>, <eos>
